...
- [shopping_list/presentation/widgets/shopping_list_share_modal.dart](../lib/features/shopping_list/presentation/widgets/shopping_list_share_modal.dart) — Dialog modal for managing list owner, adding new collaborators with optional display names, and deleting existing collaborators with confirmation.
- [shopping_list/domain/usecases/remove_collaborator.dart](../lib/features/shopping_list/domain/usecases/remove_collaborator.dart) — Single-responsibility use case for removing a collaborator from a list.
- [shopping_list/presentation/widgets/add_item_input.dart](../lib/features/shopping_list/presentation/widgets/add_item_input.dart) — Quick inline checklist entry bar featuring dynamic auto-completion suggestion chips for checked items.
